...
<?php
    ...
    // Verificando se nome_pesquisar foi declarado em GET ou POST
    if (isset($_GET['nome_pesquisar'])) {
        $nome_pesquisar = $_GET['nome_pesquisar'];
    } else {
...
<div id="container">
  ...
  <div id="tweet-container">
    ...
    require 'php/pesquisar_tweets.php';
    ?>
  </div>
